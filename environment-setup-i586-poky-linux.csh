setenv SDKTARGETSYSROOT /scratch/opt/sysroots/i586-poky-linux
setenv PATH /scratch/opt/sysroots/x86_64-pokysdk-linux/usr/bin:/scratch/opt/sysroots/x86_64-pokysdk-linux/usr/bin/i586-poky-linux:$PATH
setenv PKG_CONFIG_SYSROOT_DIR $SDKTARGETSYSROOT
setenv PKG_CONFIG_PATH $SDKTARGETSYSROOT/usr/lib/pkgconfig
setenv CONFIG_SITE /scratch/opt/site-config-i586-poky-linux
setenv OECORE_NATIVE_SYSROOT "/scratch/opt/sysroots/x86_64-pokysdk-linux"
setenv OECORE_TARGET_SYSROOT "$SDKTARGETSYSROOT"
setenv OECORE_ACLOCAL_OPTS "-I /scratch/opt/sysroots/x86_64-pokysdk-linux/usr/share/aclocal"
setenv PYTHONHOME /scratch/opt/sysroots/x86_64-pokysdk-linux/usr
...
setenv CONFIGURE_FLAGS "--target=i586-poky-linux --host=i586-poky-linux --build=x86_64-linux --with-libtool-sysroot=$SDKTARGETSYSROOT"
...
setenv OECORE_DISTRO_VERSION "1.7.1"
setenv OECORE_SDK_VERSION "1.7.1"
setenv ARCH x86
